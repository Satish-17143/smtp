...
SECRET_KEY = 'django-insecure-q%(_mu*@oua$&2p+vpso=a3o8#!r_kg%5*0^lbs6if@6(@p&(&'
...
EMAIL_HOST_USER = 'chendu167@gmail.com'
EMAIL_HOST_PASSWORD = 'rfrydjthfjxirswl'
EMAIL_USE_TLS = True  # or False if your SMTP server doesn't use TLS
DEFAULT_FROM_EMAIL = 'chendu167@gmail.com'